...
const Contact = () => {
    return (
      <section id='contact' className=' w-full  justify-center h-fit min-h-screen mt-0 text-white flex flex-col bg-slate-900'>
        <div className="mt-[6%] items-center flex justify-center">
          <div className="w-full flex flex-col laptop:space-y-8 desktop:space-y-8 space-x-4 basis basis-full laptop:px-[12%] desktop:px-[12%] px-1">
            ...
            <div className="flex flex-col laptop:flex-row desktop:flex-row  bg-slate-800">
