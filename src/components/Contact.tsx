  ...
  const handleClosePopup = () => {
    ...
    return (
      <><section id='contact' className='contact w-full  justify-center h-fit min-h-screen mt-0 text-white flex flex-col  relative'>
        ...
        <div className="laptop:h-[8%] tablet:h-[8%] h-[5%] laptop:w-[10%] w-[35%] absolute laptop:right-11 right-11 top-0 border-r-2 border-[#EEBA2B]">
        </div>
        {showPopup && (
          <Popup
      ...
      </section><Footer setShowPopUp={setShowPopup} /></>
