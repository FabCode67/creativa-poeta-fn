    ...
    <section id='faq' className='faq justify-center h-fit min-h-screen mt-0 flex flex-col bg-white items-center relative pb-3'>
      ...
      <div className="mt-[2%] laptop:px-40 px-2">
        ...
        >
          {faqData.map((faq) => (
          <Link
            className="bg-yellow-500 px-4 py-2 h-[35rem]" to={`/faq/${faq.id}`} key={""}>
            {/* <img
              src={faq.image}
              alt="test"
      ...
      <div className="laptop:h-[10%] tablet:h-[13%] h-[8%] laptop:w-[10%] w-[35%] absolute laptop:right-20 right-11 top-0 border-r-2 border-yellow-800">
      </div>
