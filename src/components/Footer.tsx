    ...
    <footer className="foote py-16 backdrop-blur-lg blur-none  laptop:px-44 desktop:px-44 px-2 bg-slate-900 text-white bottom-0 w-full h-fit flex flex-col">
      <div className="laptop:flex-row desktop:flex-row flex-col flex justify-center items-center w-full  laptop:space-x-16 desktop:space-x-16 space-x-0">
        <div className="flex flex-col laptop:w-1/2 desktop:w-1/2 w-full h-fit ">
          ...
          <p className='flex justify-start text-left items-start float-left mt-3 text-slate-700'>
        ...
        <div className="flex space-x-10 mt-16 justify-center items-center basis-full text-slate-700">
          <p>
        ...
        <div className='powerdby flex flex-row justify-center items-center'>
          ...
          <a href="https://fabcode67.github.io/my-brand-fabrice" target="_blank" rel="noreferrer text-slate-700">
           <p className='text-xs ml-2 text-gray-700'>fabrice.mwanafunzi@karisimbi.rw</p>
          </a>
          </div>
    </footer>
  );
