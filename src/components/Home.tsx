        ...
        <div className="flex justify-between">
          <div className="flex flex-col laptop:w-[70%] tablet:w-[70%] w-full justify-start items-start">
            <div className="space-y-3 laptop:space-y-0 ">
              <h1 className="text-2xl font-bold text-gray-500 mx-0">WELCOME TO CREATIVA POETA</h1>
              <p className="laptop:text-7xl text-4xl leading-tight laptop:text-left tablet:text-left text-center font-semibold text-white">We are a creative group of people who design influential brands and digital experiences.</p>
            </div>
            <div className="flex laptop:flex-row tablet:flex-row flex-col laptop:space-x-5 tablet:space-x-5 mt-12 mx-auto laptop:mx-0 w-full space-y-4 laptop:space-y-0 tablet:space-y-0">
              <button className="hover:bg-white hover:text-black text-white px-10 py-3 border-2 border-white">START A PROJECT</button>
              <button className="hover:bg-white hover:text-black text-white px-10 py-3 border-2 border-white">MORE ABOUT US</button>
            </div>
          </div>
          <div className="laptop:block tablet:block hidden">
            <div className="flex flex-col space-y-5 py-20">
              <div
                className="group rounded-full h-[3rem] w-[3rem] border-4 text-white text-center items-center flex justify-center text-xl border-white cursor-pointer"
