...
{currentBackground.video && (
    ...
    >
      ...
      <div className="logo laptop:top-5 desktop:top-5 tablet:top-4 md:top-4 top-6  text-white laptop:text-4xl desktop:text-4xl text-xl  left-8 ml-11  absolute laptop:p-1 desktop:p-1">
        Creativa Poeta
      </div>
      <div className="">
